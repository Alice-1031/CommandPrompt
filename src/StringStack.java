...
/**
 * This class simulates a stack using a private array list
 * 
...
public class StringStack {
    ...
    /**
     * * Method to add an item to the top of the stack. * @param item The String to
    ...
    /**
     * * Method to remove and return the top item from the stack. * * @return
